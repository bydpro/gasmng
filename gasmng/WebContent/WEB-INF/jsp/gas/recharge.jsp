...
<form id="myUserForm" method="post">
	...
	<div style="margin-bottom: 7px;">
		...
		<ul class="dowebok" onclick="getSelVal()">
			<li><input type="radio" name="radio" data-labelauty="20"
				value="20"></li>
			<li><input type="radio" name="radio" data-labelauty="50"
				value="50"></li>
			<li><input type="radio" name="radio" data-labelauty="100"
				value="100"></li>
			<br>
			<li><input type="radio" name="radio" data-labelauty="200"
				value="200"></li>
			<li><input type="radio" name="radio" data-labelauty="300"
				value="300"></li>
			<li><input type="radio" name="radio" data-labelauty="500"
				value="500"></li>
		</ul>
	</div>
	<div style="margin-bottom: 7px;">
		<label>充值金额：</label> <label id="reMoneyLable" style="color: red;"></label>
		<input name="reMoney" class="easyui-validatebox"
